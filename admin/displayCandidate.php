...
if($isDataAvailable>0){
    ...
    <td><?php echo $candidate['inserted_on'];?> </td>
    <td>
...
<tr>
    <th class="bg-yellow text-center text-white" colspan="4"> <a href="#candidates" class="btn btn-success">Please Enter
            Candidates</a>
    </th>
    <th class="bg-yellow text-center text-white" colspan="4"> <a href="index.php?AddElection"
